...
This is the most fine-grained render optimization the runtime offers, but it covers only native elements' signal children and the props above. Signals passed to React component props or component children are not unwrapped.
